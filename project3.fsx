...
let peer (mailbox: Actor<_>) =
    ...
    let mutable successorAddress = ""
    let mutable selfAddressString = ""
    ...
    let rec loop() =
        actor {
            ...
            | Initiate(_) ->
                ...
                selfAddressString <- mailbox.Self.Path.Name.Split('_').[1]
    ...
    let rec loop() =
        actor {
            ...
            | Start(_) ->
                ...
                let fin = peersList.[rnd.Next(0, peersList.Length - 1)]
